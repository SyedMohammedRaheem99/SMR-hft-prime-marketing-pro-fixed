...
const projectsData = [
  {
    ...
    images: ["/assets/masterai1.png", "/assets/masterai2.png", "/assets/masterai3.png", "/assets/masterai4.png", "/assets/masterai5.png", "/assets/masterai6.png", "/assets/masterai7.png"],
  ...
  },
  {
    ...
    images: ["/assets/codereviewai1.png", "/assets/codereviewai2.png", "/assets/codereviewai3.png", "/assets/codereviewai4.png"],
  ...
  },
  {
    ...
    images: ["/assets/interior1.png", "/assets/interior2.png"],
  ...
  },
  {
    ...
    images: ["/assets/freshly-app-mockups.png", "/assets/freshly-1.png", "/assets/freshly-2.png", "/assets/freshly-3.png", "/assets/freshly-4.png", "/assets/freshly-5.png", "/assets/freshly-6.png"],
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            <motion.div className="flex items-center gap-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-900/20 rounded-full" whileHover={{ scale: 1.05 }}>
              <span>🎯</span>
              <span className="font-medium text-indigo-700 dark:text-indigo-300">99% Client Satisfaction</span>
            </motion.div>
            
            <motion.div className="flex items-center gap-2 px-4 py-2 bg-purple-50 dark:bg-purple-900/20 rounded-full" whileHover={{ scale: 1.05 }}>
              <span>⚡</span>
              <span className="font-medium text-purple-700 dark:text-purple-300">Lightning Fast Delivery</span>
            </motion.div>
            
            <motion.div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-900/20 rounded-full" whileHover={{ scale: 1.05 }}>
              <span>🚀</span>
